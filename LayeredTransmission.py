...
#%% Device Setup
cwl_bottom = 0.380 #Wavelength in um, roughly corresponds to 2.15 eV, the absorption edge of MC
...
lower = PeriodicStructure([al2o3,sio2],periodicity=18)
upper = PeriodicStructure([sio2,al2o3],periodicity=18)
